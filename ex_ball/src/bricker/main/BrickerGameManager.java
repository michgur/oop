...
public class BrickerGameManager extends GameManager {
  ...
  public void initializeGame(
    ...
    // open assets
    Renderable ballRenderable = imageReader.readImage("assets/ball.png", true),
        paddleRenderable = imageReader.readImage("assets/paddle.png", true),
        backgroundRenderable = imageReader.readImage("assets/DARK_BG2_small.jpeg", false),
        brickRenderable = imageReader.readImage("assets/brick.png", false),
        heartRenderable = imageReader.readImage("assets/heart.png", true);
    ...
    paddle = new Paddle(Vector2.ZERO, paddleSize, paddleRenderable, inputListener, windowDimensions, 5);
    paddle.setCenter(new Vector2(
        windowDimensions.x() / 2,
        windowDimensions.y() - (paddleSize.y() / 2) - (BORDER_WIDTH * 2)));

    GameObject wallLeft = new GameObject(Vector2.ZERO, new Vector2(BORDER_WIDTH, windowDimensions.y()), null);
    ...
    GameObject numericLifeCounter = new NumericLifeCounter(
        ...
        heartDimensions,
        gameObjects());
    GameObject graphicLifeCounter = new GraphicLifeCounter(uiTopLeftCorner.add(new Vector2(heartDimensions.x(), 0)),
        heartDimensions, lifeCounter, heartRenderable, gameObjects(), LIFE_PER_GAME);
   ...
   * 
   * @param brickRenderable The renderable to use for the bricks.
  ...
  public static void main(String[] args) {
    BrickerGameManager gameManager = new BrickerGameManager("Bricker", new Vector2(800, 600));
    gameManager.run();
  }
}
